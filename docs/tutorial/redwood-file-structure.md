...
- `dist` contains the compiled code for the web side and can be ignored when developing.
...
- `types` contains automatically compiled GraphQL types and can be ignored during development.
